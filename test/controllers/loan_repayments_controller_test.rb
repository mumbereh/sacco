...
class LoanRepaymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loan_repayment" do
    assert_difference("LoanRepayment.count") do
      post loan_repayments_url, params: { loan_repayment: { loan_id: @loan_repayment.loan_id, member_id: @loan_repayment.member_id, note: @loan_repayment.note, payment_amount: @loan_repayment.payment_amount, payment_date: @loan_repayment.payment_date } }
    end
  ...
  test "should update loan_repayment" do
    patch loan_repayment_url(@loan_repayment), params: { loan_repayment: { loan_id: @loan_repayment.loan_id, member_id: @loan_repayment.member_id, note: @loan_repayment.note, payment_amount: @loan_repayment.payment_amount, payment_date: @loan_repayment.payment_date } }
